...
@section('page-title', 'طلبات تغيير الوردية')
@section('page-subtitle', 'مراجعة واعتماد طلبات تغيير الورديات')
        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="py-3 px-4 text-gray-600">{{ $req->currentShift?->name ?? '-' }}</td>
                    <td class="py-3 px-4 text-gray-600">{{ $req->requestedShift?->name ?? '-' }}</td>
                    <td class="py-3 px-4 text-gray-600">{{ $req->effective_date->format('Y/m/d') }}</td>
                    <td class="py-3 px-4">
                    ...
                    <td class="py-3 px-4">
                        <a href="{{ route('admin.shift-change-requests.show', $req) }}" class="text-blue-600 hover:text-blue-800 text-xs font-medium">
                            عرض التفاصيل
                        </a>
                    </td>
                </tr>
                @empty
                <tr>
                    <td colspan="7" class="text-center py-12 text-gray-400">لا توجد طلبات تغيير وردية</td>
                </tr>
                @endforelse
            </tbody>
        </table>
