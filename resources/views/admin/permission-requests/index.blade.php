...
@section('page-title', 'طلبات الأذون')
@section('page-subtitle', 'مراجعة واعتماد طلبات الأذون')
        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="py-3 px-4 text-gray-600">{{ $req->minutes_count }} دقيقة</td>
                    <td class="py-3 px-4">
                    ...
                    <td class="py-3 px-4">
                        <a href="{{ route('admin.permission-requests.show', $req) }}" class="text-blue-600 hover:text-blue-800 text-xs font-medium">
                            عرض التفاصيل
                        </a>
                    </td>
                </tr>
                @empty
                <tr>
                    <td colspan="7" class="text-center py-12 text-gray-400">لا توجد طلبات أذون</td>
                </tr>
                @endforelse
            </tbody>
        </table>
