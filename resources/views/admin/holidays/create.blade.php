    ...
    <form method="POST" action="{{ route('admin.holidays.store') }}">
        ...
        <div class="space-y-5">
            <div>
                ...
                <input type="date" name="date" value="{{ old('date') }}" class="w-full border rounded-xl px-4 py-2.5 @error('date') border-red-400 @enderror">
            ...
            <div class="flex items-center gap-2">
                <input type="checkbox" name="is_recurring" value="1" id="is_recurring" {{ old('is_recurring') ? 'checked' : '' }}>
